        ...
        this.run = (profileUrl) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const rawUserProfileData = yield page.evaluate(() => {
                    ...
                    const fullNameElement = profileSection === null || profileSection === void 0 ? void 0 : profileSection.querySelector('h1.text-heading-xlarge.inline.t-24.v-align-middle.break-words:first-child');
                    const fullName = (fullNameElement === null || fullNameElement === void 0 ? void 0 : fullNameElement.textContent) || null;
                    const titleElement = profileSection === null || profileSection === void 0 ? void 0 : profileSection.querySelector('div.text-body-medium.break-words:first-child');
                    const title = (titleElement === null || titleElement === void 0 ? void 0 : titleElement.textContent) || null;
                    const locationElement = profileSection === null || profileSection === void 0 ? void 0 : profileSection.querySelector('span.text-body-small.inline.t-black--light.break-words:first-child');
                ...
                const rawExperiencesData = yield page.$$eval('#experience-section ul > .ember-view', (nodes) => {
                    ...
                    for (const node of nodes) {
                        ...
                        const location = (locationElement === null || locationElement === void 0 ? void 0 : locationElement.textContent) || null;
                        const jobSections = node.querySelectorAll('li.pv-entity__position-group-role-item');
                        const jobSectionsFading = node.querySelectorAll('li.pv-entity__position-group-role-item-fading-timeline');
                        const jobRoles = [];
                        console.log('+++++++++++++++job section type++++++++++++', jobSections);
                        jobSections.forEach((role) => {
                            const roleN = role.querySelector('h3 span:not(.visually-hidden)');
                            const jobNewTi = (roleN === null || roleN === void 0
                                ? void 0
                                : roleN.textContent) || null;
                            const roledescriptionElement = role.querySelector('.pv-entity__description');
                            const roledescription = (roledescriptionElement === null || roledescriptionElement === void 0
                                ? void 0
                                : roledescriptionElement.textContent) || null;
                            const roledateRangeElement = role.querySelector('.pv-entity__date-range span:nth-child(2)');
                            const roledateRangeText = (roledateRangeElement === null || roledateRangeElement === void 0
                                ? void 0
                                : roledateRangeElement.textContent) || null;
                            const rolestartDatePart = (roledateRangeText === null || roledateRangeText === void 0
                                ? void 0
                                : roledateRangeText.split('–')[0]) || null;
                            const rolestartDate = (rolestartDatePart === null || rolestartDatePart === void 0
                                ? void 0
                                : rolestartDatePart.trim()) || null;
                            const roleendDatePart = (roledateRangeText === null || roledateRangeText === void 0
                                ? void 0
                                : roledateRangeText.split('–')[1]) || null;
                            const roleendDateIsPresent = (roleendDatePart === null || roleendDatePart === void 0
                                ? void 0
                                : roleendDatePart.trim().toLowerCase()) === 'present' || false;
                            const roleendDate = roleendDatePart && !roleendDateIsPresent
                                ? roleendDatePart.trim()
                                : 'Present';
                            const rolelocationElement = role.querySelector('.pv-entity__location span:nth-child(2)');
                            const rolelocation = (rolelocationElement === null || rolelocationElement === void 0
                                ? void 0
                        ...
                        const companyWithRole = node.querySelector('.pv-entity__company-summary-info span:not(.visually-hidden)');
